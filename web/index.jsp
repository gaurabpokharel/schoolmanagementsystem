<%-- 
    Document   : index
    Created on : 28-Jul-2020, 18:45:11
    Author     : gaura
--%>
...
<html>
<head>
    <link rel="icon" type="image/png" href="images/icon/abc.ico"/>
...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header">
      ...
      <h1><a class="navbar-brand" href="#">XYZ</a></h1>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="#services" class="page-scroll">Facilities</a></li>
		<li><a href="#team" class="page-scroll">Team</a></li>
		<li><a href="#gallery" class="page-scroll">Gallery</a></li>
		<li><a href="#testimonials" class="page-scroll">Testimonials</a></li>
		<li><a href="#contact" class="page-scroll">Contact</a></li>
		<li> <select  onchange="location = this.value;"  style="color:white; border:0px; width: 110px;height: 40px;background-color:transparent;font-size: 15px;
    letter-spacing: 2px;    font-weight: 400;    text-transform: uppercase;">
                        <option style="color: #207dff"> SIGN IN </option><option style="color: #207dff" value="adminLogin.jsp">ADMIN LOGIN </option> <option style="color: #207dff" value="studentLogin.jsp">STUDENT LOGIN </option> </select> </li>
						...
						<ul class="slides">
							<li>
								<div class="wthree_banner_info_grid">
									...
									<p>Education is a lifetime process with no true beginning or ending..
                                                                            <br>Education is not preparation for life; Education is life itself.</p>
								</div>
							</li>
							<li>
								<div class="wthree_banner_info_grid">
									<h3>Never Stop Learning</h3>
                                                                        <p>Without learning new things, we will remain unaware of wonderful things in the world.<br>
                                                                         Learning is about enriching our minds, honing our skills, and changing the way we see the world and ourselves.</p>
								</div>
							</li>
							<li>
								<div class="wthree_banner_info_grid">
									<h3>Learning Never Ends</h3>
                                                                        <p>The whole purpose of education is to turn mirrors into windows.<br>
                                                                        </p>
								</div>
							</li>
						</ul>
...
<div class="container">
<h3>About Us</h3>
<p class="w3_dwn">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500sLorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
		...
		<div class="w3ls_banner_bottom_grids">
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#banana" id="banana-tab" role="tab" data-toggle="tab" aria-controls="banana" aria-expanded="true">Physics</a></li>
					<li role="presentation"><a href="#apple" role="tab" id="apple-tab" data-toggle="tab" aria-controls="apple">English</a></li>
					<li role="presentation"><a href="#lemon" role="tab" id="lemon-tab" data-toggle="tab" aria-controls="lemon">Testing</a></li>
					<li role="presentation"><a href="#Strawberry" role="tab" id="Strawberry-tab" data-toggle="tab" aria-controls="Strawberry">Lab</a></li>
				</ul>
